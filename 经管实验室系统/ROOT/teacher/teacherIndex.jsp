	...
	<div style="margin:0 auto;width:1024px;min-height:768px;overflow-y:scrooll;">
		...
		<div style="height:124px;width:1024px;background:url(${pageContext.request.contextPath}/images/h1.gif);">
			<div style="float:right;height:22px;width:320px;margin-top:102px;">
				您好&nbsp;<span style="color: rgb(0, 136, 204);cursor:pointer" onclick="teacher_teacherIndex_myInfo();">${sessionScope.user.userName }</span>&nbsp;|身份-${sessionScope.user.type}&nbsp;<a style="cursor:pointer;color:rgb(0, 136, 204);" onclick="teacher_teacherIndex_logout();">退出</a>
		...
		<div style="height:112px;border:1px #FFFFFF solid;background:url(${pageContext.request.contextPath}/images/foot.jpg)">
			...
			<div style="height:18px;margin:2px;font-size:12px;text-align:left;">
				...
				<span style="margin-left:12px;"><a href="http://172.22.4.29" target="_blank">开放上机</a></span><span style="margin-left:12px;"><a href="http://202.202.43.125" target="_blank">网址大全</a></span><span style="margin-left:12px;"><a href="http://172.22.4.2/ceo/teacher/teacher.html" target="_blank">仿真系统</a></span>		
			</div>
		</div>
