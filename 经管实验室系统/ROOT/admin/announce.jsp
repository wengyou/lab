...
<div id="admin_announce_toolbar" style="height:28px;border-bottom:1px solid #F3F3F3">
    <div style="float:left">
        <a onclick="admin_announce_add()" class="easyui-linkbutton"
           data-options="iconCls:'icon-add',plain:true">添加公告</a>
        <a onclick="admin_announce_remove()" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true">删除公告</a>
        <a onclick="admin_announce_save()" class="easyui-linkbutton"
    ...
    <div style="float:left;margin-left:12px;margin-top:3px">
        <input class="easyui-searchbox" style="width:300px"
               data-options="searcher:admin_announce_search,prompt:'请输入搜索信息',menu:'#admin_announce_search'"></input>
