	...
	<form method="post" id="user-registerForm">
		<table id="tb1">
			<tr>
				...
				<td><input id="userId"  name="userId" value=""  type="text" /><td>
				<td>姓名<td>
			...
			<tr>
				...
				<td><input value=""  type="text" id="password" name="password" /><td>
