...
public class RegisterService {
	...
	public Map<String,Object> getRegister(Register rgs){
		...
		String sql = "select register.id,register.userId,register.userName,register.academy,register.discipline,register.cls," +
				"register.grade,register.sex,user.userName as teacherName,register.state,register.type,register.password,register.phone,register.registerDate" +
		...
		try {
			...
			while(rs.next()){
				...
				r.setRegisterDate(rs.getString("registerDate"));
				al.add(r);
			}
	...
	public boolean grantRegister(Register rgs) {
		...
		Connection conn = null;
		PreparedStatement ps = null;
		String sql = "INSERT IGNORE INTO USER(userId,userName,academy,grade,discipline,cls,sex,phone,TYPE,PASSWORD,registerDate) " +
				"SELECT userId,userName,academy,grade,discipline,cls,sex,phone,TYPE,PASSWORD,registerDate"+
