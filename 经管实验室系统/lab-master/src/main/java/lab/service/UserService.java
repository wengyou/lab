...
public class UserService {
    ...
    public User login(User user) {
        ...
        String sql = "select userId,userName,type from user where userId=? and password=?";
        try {
    ...
    public boolean register(User user) {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String sql = "insert IGNORE into register(userId,userName,academy,grade,discipline,cls,sex,phone,type,password,teacherId,registerDate) value(?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public Map<String, Object> getUserByType(User user) {
        ...
        String sql = "select id,userId,userName,academy,discipline,cls,grade,sex,type,password,phone,securityQuestion,answer,registerDate from user where 1=1 and type='"
                + user.getType() + "'";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                u.setRegisterDate(rs.getString("registerDate"));
                al.add(u);
            }
